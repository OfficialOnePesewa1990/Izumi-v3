...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~fHSmRnz1",
  ...
  BOT_NAME: process.env.BOT_NAME || "OFFICIAL ONEPESEWA",
  SUDO: process.env.SUDO || 233544482494
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "OFFICIAL ONEPESEWA,❤️",
  AUDIO_DATA: process.env.AUDIO_DATA || "Eʏᴘᴢ;Iᴢᴜᴍɪ-ᴠ3;https://i.imgur.com/cO0TZJv.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "OFFICIAL ONEPESEWA",
  AUTHOR: process.env.AUTHOR || "OFFICIAL ONEPESEWA",
